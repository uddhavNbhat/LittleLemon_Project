                ...
                <div className='container-fluid'>
                    ...
                    <div className='collapse navbar-collapse navbar-nav-scroll' id="navbarScroll">
                        <ul className='navbar-nav justify-content-center w-50 d-flex'>
                            <li className='nav-item p-2'><Link to="/" smooth={true} spy = {true} offset={50} duration={100} className="nav-link">Home</Link></li>
                            ...
                            <li className='nav-item p-2'><Link to="reservations" smooth={true} spy = {true} offset={50} duration={100} className="nav-link" href='#'>Reservations</Link></li>
